...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Intercity Taxi Booking`}</title>

        <meta
          name="description"
          content="Experience seamless travel with Intercity Taxi Booking - Book your intercity journey in advance, secure your ride, and enjoy 24/7 customer support for an effortless journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593018931419-96adfd5b182d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnRlcmNpdHklMjBqb3VybmV5fGVufDB8fHx8MTY5NTE5NjUxNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lapunin?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Sergey Lapunin`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless travel with Intercity Taxi Booking - Book your intercity journey in advance, secure your ride, and enjoy 24/7 customer support for an effortless journey.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Customer Support Representative"
