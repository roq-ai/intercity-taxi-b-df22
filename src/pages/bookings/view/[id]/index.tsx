            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  label="Journey Date"
                  text={
                    data?.journey_date ? format(parseISO(data?.journey_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem
                  label="Journey Time"
                  text={
                    data?.journey_time ? format(parseISO(data?.journey_time as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
