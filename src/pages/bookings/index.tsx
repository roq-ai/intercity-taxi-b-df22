  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.journey_date ? format(parseISO(record?.journey_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'journey_time',
      header: 'Journey Time',
      accessorKey: 'journey_time',
      cell: ({ row: { original: record } }: any) =>
        record?.journey_time ? format(parseISO(record?.journey_time as unknown as string), 'dd-MM-yyyy') : '',
    },
