...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.update': {
    roles: ['business-owner', 'team-member', 'customer-support-representative'],
    key: 'booking-update',
    tenantPath: ['organization', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['business-owner', 'team-member', 'customer-support-representative'],
...
const ownerRoles: string[] = ['customer-support-representative'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['business-owner', 'team-member', 'customer-support-representative'];
